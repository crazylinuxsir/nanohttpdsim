package com.example.linuxsir.nanosimple.test2;
...
public class Nanoo
{
     ...
     */
    public Nanoo(int port, File wwwroot) throws IOException
    {
        myTcpPort = port;
...
//    }
    ...
    public String getLocalIpAddress() {
        // 遍历网络接口
        Enumeration<NetworkInterface> infos = null;
        try {
            infos = NetworkInterface
